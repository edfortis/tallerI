...
begin
  ...
  //query:='SELECT CONCAT_WS('' '',nombre, aPaterno, aMaterno) AS NombreCompleto, correoElectronico as CorreoElectronico, telefono as Teléfono FROM empleado WHERE aPaterno LIKE'+QuotedStr('%'+EBuscar.Text+'%');
