...
begin
   ...
   begin
      cadena:='UPDATE `tintoreria`.`usuario` SET `nombre` = '+QuotedStr(EUsuario.Text)+', `contrasena` =  '+QuotedStr(EContraseañ.Text)+' , `empleado_idEmpleado` ='+ IntToStr( ComboEmpleados.KeyValue)+'  WHERE `idUsuario` = '+ IntToStr( UUsuario.identificador);
   end;
